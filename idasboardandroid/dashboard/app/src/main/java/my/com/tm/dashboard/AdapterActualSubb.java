...
public class AdapterActualSubb extends ArrayAdapter implements Filterable {

    private List<ModelActualSubb> GatedList;
    private List<ModelActualSubb> orig;
    private int resource;
    private LayoutInflater inflator;

    public AdapterActualSubb(Context context, int resource, List<ModelActualSubb> objects) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                final ArrayList<ModelActualSubb> results = new ArrayList<ModelActualSubb>();
                if (orig == null)
                    orig = GatedList;
                if (constraint != null) {
                    if (orig != null && orig.size() > 0) {
                        for (final ModelActualSubb g : orig) {
...
//                                results.add(g);
            ...
            protected void publishResults(CharSequence constraint,
                ...
                GatedList = (ArrayList<ModelActualSubb>) results.values;
