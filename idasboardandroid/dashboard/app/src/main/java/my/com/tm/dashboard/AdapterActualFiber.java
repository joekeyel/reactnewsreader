...
public class AdapterActualFiber extends ArrayAdapter implements Filterable {
    ...
    private List<ModelActualFiber> GatedList;
    private List<ModelActualFiber> orig;
    private int resource;
    private LayoutInflater inflator;

    public AdapterActualFiber(Context context, int resource, List<ModelActualFiber> objects) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                final ArrayList<ModelActualFiber> results = new ArrayList<ModelActualFiber>();
                if (orig == null)
                    orig = GatedList;
                if (constraint != null) {
                    if (orig != null && orig.size() > 0) {
                        for (final ModelActualFiber g : orig) {
...
//                                results.add(g);
            ...
            protected void publishResults(CharSequence constraint,
                ...
                GatedList = (ArrayList<ModelActualFiber>) results.values;
